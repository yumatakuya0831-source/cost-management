...
export default async function AdminUsersPage() {
  ...
  return <main className="min-h-screen bg-[#f6f3ee] px-5 py-8 text-[#28251f] lg:px-10"><div className="mx-auto max-w-6xl">
    ...
    <section className="mt-7 rounded-2xl border border-stone-200 bg-white p-6 shadow-sm"><h2 className="font-bold">新しい許可ユーザー</h2><p className="mt-1 text-xs text-stone-500">登録したメールアドレスと同じGoogleアカウントだけが初回ログインできます。</p><div className="mt-5"><UserForm /></div></section>
