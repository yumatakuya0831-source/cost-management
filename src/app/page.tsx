    ...
    <div className="min-h-screen bg-[#f6f3ee] text-[#28251f]">
      ...
      <main className="px-5 py-6 lg:ml-64 lg:px-9 lg:py-8">
        ...
        <section className="mt-5 rounded-2xl border border-stone-200/80 bg-white p-6 shadow-[0_8px_24px_rgba(60,50,35,0.04)]">
          <div className="flex items-center justify-between"><div><h2 className="font-bold">商品別原価</h2><p className="mt-1 text-xs text-stone-400">仕込み原価を販売個数で集計</p></div><Link className="text-sm font-semibold text-[#a45f20]" href="/products">すべて見る →</Link></div>
